          ...
          <div className="mx-auto max-w-4xl">
            <div className="mb-10 space-y-4">
              ...
              <p className="text-muted-foreground text-base md:text-lg">
                Your privacy matters. This policy explains how 90's Burger collects, uses, and
            ...
            <div className="space-y-6">
              <section className="glass-card p-6 md:p-8 space-y-4">
                ...
                <p className="text-sm md:text-base text-muted-foreground">
                  90's Burger collects only the information we need to deliver orders, support
              ...
              <section className="glass-card p-6 md:p-8 space-y-4">
                ...
                <p className="text-sm md:text-base text-muted-foreground">
                  90's Burger is not directed to children under 13, and we do not knowingly collect
