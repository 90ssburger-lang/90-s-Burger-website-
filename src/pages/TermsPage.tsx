          ...
          <div className="mx-auto max-w-4xl">
            <div className="mb-10 space-y-4">
              ...
              <p className="text-muted-foreground text-base md:text-lg">
                These terms set the expectations for using the 90's Burger website and services.
            ...
            <div className="space-y-6">
              <section className="glass-card p-6 md:p-8 space-y-4">
                ...
                <p className="text-sm md:text-base text-muted-foreground">
                  By accessing or using 90's Burger, you agree to these Terms &amp; Conditions and any
              ...
              <section className="glass-card p-6 md:p-8 space-y-4">
                ...
                <p className="text-sm md:text-base text-muted-foreground">
                  All content, designs, graphics, and trademarks on 90's Burger are owned by or licensed
              ...
              <section className="glass-card p-6 md:p-8 space-y-4">
                ...
                <p className="text-sm md:text-base text-muted-foreground">
                  If you submit reviews or other content, you grant 90's Burger permission to display
              ...
              <section className="glass-card p-6 md:p-8 space-y-4">
                ...
                <p className="text-sm md:text-base text-muted-foreground">
                  The 90's Burger site and services are provided "as is" and "as available" without
              ...
              <section className="glass-card p-6 md:p-8 space-y-4">
                ...
                <p className="text-sm md:text-base text-muted-foreground">
                  To the maximum extent permitted by law, 90's Burger will not be liable for indirect,
              ...
              <section className="glass-card p-6 md:p-8 space-y-4">
                ...
                <p className="text-sm md:text-base text-muted-foreground">
                  You agree to indemnify and hold 90's Burger harmless from any claims, damages, or
              ...
              <section className="glass-card p-6 md:p-8 space-y-4">
                ...
                <p className="text-sm md:text-base text-muted-foreground">
                  ...
                  <a
                    href="mailto:orders@90sburger.com"
                    className="text-primary hover:text-primary/80 underline-offset-4 hover:underline transition-colors"
                  >
                    orders@90sburger.com
                  </a>
                  .
                </p>
