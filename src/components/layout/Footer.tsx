...
export function Footer() {
  ...
  return <footer className="bg-primary text-primary-foreground">
    <div className="container mx-auto grid gap-10 px-4 py-14 md:grid-cols-3">
      <div>
        <img src="/images/90s-burger-logo.png" width="128" height="128" loading="lazy" alt="90's Burger" className="h-32 w-32 rounded-2xl border border-white/15 object-cover" />
