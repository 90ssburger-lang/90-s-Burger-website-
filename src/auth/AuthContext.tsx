...
export function AuthProvider({children}:{children:ReactNode}){
 ...
 const role=profile?.role??'customer';const value=useMemo(()=>({user,session,profile,loading,roles:user?[role]:[],isAdmin:role==='admin',isStaff:role==='admin'||role==='manager',signUp,signIn,resetPassword,signOut,refreshProfile}),[user,session,profile,loading,role,signUp,signIn,resetPassword,signOut,refreshProfile]);
